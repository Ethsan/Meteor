...
class MainScreen : public State {
	...
	MainScreen(const SDL::Window &window, const SDL::Renderer &renderer)
		: window_(window)
		, renderer_(renderer)
		, title_("Meteor", title, fg, hl, renderer_, 132, 35)
		, play_("Play", menu, fg, hl, renderer_, 160, 95)
		, exit_("Exit", menu, fg, hl, renderer_, 160, 145)
		, editor_("Editor", menu, fg, hl, renderer_, 160, 195)
